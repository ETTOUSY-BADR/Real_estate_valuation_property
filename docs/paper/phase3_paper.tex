...
MAE reduction is EUR 3,293, or 3.41\%, with a paired 95\% bootstrap interval of
...
EUR 3,293 (3.41\%), improves MdAPE from 12.22\% to 11.70\%, increases the share
...
improvement is meaningful but bounded. A 3.41\% MAE reduction does not remove
